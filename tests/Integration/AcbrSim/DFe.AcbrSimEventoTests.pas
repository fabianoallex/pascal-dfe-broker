...
{ Fase 4 do simulador (docs/simulador-sefaz.md): EnviarEvento -- a
  ...
  Sem eles os testes sao IGNORADOS (nao passam em silencio: o runner conta
  os ignorados). }
...
var
  ...
  LEv: TDFeEventoNormalizado;
begin
  LJust := 'Mercadoria n' + #$C3#$A3 + 'o foi entregue no prazo combinado'; // "nao" com til, em UTF-8
  ...
  AssertEquals('xJust sai sem acentos', LSemAcento, ExtrairTag(FTransmissor.UltimoEnvelope, 'xJust'));
