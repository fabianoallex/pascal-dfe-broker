...
3. **Consumidores de exemplo** em outras linguagens (Node, C#, Java, PHP…) — hoje há Python e Pascal (Delphi/Lazarus, com tela). Uma variante Pascal **console** (sem tela) é a [issue #11](https://github.com/fabianoallex/pascal-dfe-broker/issues/11).
