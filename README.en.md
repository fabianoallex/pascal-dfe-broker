...
**Without building anything (Windows x64):** download the package from the [v0.1.0 release](https://github.com/fabianoallex/pascal-dfe-broker/releases/tag/v0.1.0) — executables, the simulator, the DLLs, a test certificate and a 6-step `LEIAME.md` (Portuguese).
